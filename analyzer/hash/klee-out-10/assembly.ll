...
; <label>:21                                      ; preds = %0
  %22 = load i32* %result, align 4, !dbg !250
  %23 = load i32* %m, align 4, !dbg !250
  %int_cast_to_i642 = zext i32 %23 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i642), !dbg !250
  %24 = shl i32 1, %23, !dbg !250
  %int_cast_to_i641 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !250
  %25 = sdiv i32 %24, 2, !dbg !250
  %26 = icmp ult i32 %22, %25, !dbg !250
...
!241 = metadata !{i32 99, i32 4, metadata !14, null}
...
!253 = metadata !{i32 786443, metadata !1, metadata !249, i32 107, i32 33, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
