...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str10, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str111, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str212, i64 0, i64 0)) #7, !dbg !222
  unreachable, !dbg !222
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #8, !dbg !224
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str313, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !232
  unreachable, !dbg !232
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str614, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !237
  unreachable, !dbg !237
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #8, !dbg !240
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  ...
  br i1 %1, label %._crit_edge, label %overflow.checked, !dbg !252
...
vector.body.unr:                                  ; preds = %vector.body.preheader
  %6 = bitcast i8* %srcaddr to <16 x i8>*, !dbg !254
  %wide.load.unr = load <16 x i8>* %6, align 1, !dbg !254, !tbaa !255
  %7 = getelementptr i8* %srcaddr, i64 16, !dbg !254
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !254
  %wide.load202.unr = load <16 x i8>* %8, align 1, !dbg !254, !tbaa !255
  %9 = bitcast i8* %destaddr to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load.unr, <16 x i8>* %9, align 1, !dbg !254, !tbaa !255
  %10 = getelementptr i8* %destaddr, i64 16, !dbg !254
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load202.unr, <16 x i8>* %11, align 1, !dbg !254, !tbaa !255
...
vector.body:                                      ; preds = %vector.body.preheader.split, %vector.body
  ...
  %13 = bitcast i8* %next.gep to <16 x i8>*, !dbg !254
  %wide.load = load <16 x i8>* %13, align 1, !dbg !254, !tbaa !255
  %next.gep.sum281 = or i64 %index, 16, !dbg !254
  %14 = getelementptr i8* %srcaddr, i64 %next.gep.sum281, !dbg !254
  %15 = bitcast i8* %14 to <16 x i8>*, !dbg !254
  %wide.load202 = load <16 x i8>* %15, align 1, !dbg !254, !tbaa !255
  %16 = bitcast i8* %next.gep105 to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load, <16 x i8>* %16, align 1, !dbg !254, !tbaa !255
  %17 = getelementptr i8* %destaddr, i64 %next.gep.sum281, !dbg !254
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load202, <16 x i8>* %18, align 1, !dbg !254, !tbaa !255
  %index.next = add i64 %index, 32
  %next.gep.1 = getelementptr i8* %srcaddr, i64 %index.next
  %next.gep105.1 = getelementptr i8* %destaddr, i64 %index.next
  %19 = bitcast i8* %next.gep.1 to <16 x i8>*, !dbg !254
  %wide.load.1 = load <16 x i8>* %19, align 1, !dbg !254, !tbaa !255
  %next.gep.sum281.1 = or i64 %index.next, 16, !dbg !254
  %20 = getelementptr i8* %srcaddr, i64 %next.gep.sum281.1, !dbg !254
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !254
  %wide.load202.1 = load <16 x i8>* %21, align 1, !dbg !254, !tbaa !255
  %22 = bitcast i8* %next.gep105.1 to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load.1, <16 x i8>* %22, align 1, !dbg !254, !tbaa !255
  %23 = getelementptr i8* %destaddr, i64 %next.gep.sum281.1, !dbg !254
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !254
  store <16 x i8> %wide.load202.1, <16 x i8>* %24, align 1, !dbg !254, !tbaa !255
  %index.next.1 = add i64 %index, 64
  %25 = icmp eq i64 %index.next.1, %n.vec
  br i1 %25, label %middle.block, label %vector.body, !llvm.loop !256
...
.lr.ph.unr:                                       ; preds = %unr.cmp304
  %26 = add i64 %resume.val8, -1, !dbg !252
  %27 = getelementptr inbounds i8* %resume.val, i64 1, !dbg !254
  %28 = load i8* %resume.val, align 1, !dbg !254, !tbaa !255
  %29 = getelementptr inbounds i8* %resume.val5, i64 1, !dbg !254
  store i8 %28, i8* %resume.val5, align 1, !dbg !254, !tbaa !255
...
.lr.ph.unr299:                                    ; preds = %.lr.ph.unr, %unr.cmp304
  ...
  %30 = add i64 %.01.unr, -1, !dbg !252
  %31 = getelementptr inbounds i8* %src.03.unr, i64 1, !dbg !254
  %32 = load i8* %src.03.unr, align 1, !dbg !254, !tbaa !255
  %33 = getelementptr inbounds i8* %dest.02.unr, i64 1, !dbg !254
  store i8 %32, i8* %dest.02.unr, align 1, !dbg !254, !tbaa !255
...
.lr.ph.unr300:                                    ; preds = %.lr.ph.unr299, %unr.cmp304
  ...
  %34 = add i64 %.01.unr303, -1, !dbg !252
  %35 = getelementptr inbounds i8* %src.03.unr301, i64 1, !dbg !254
  %36 = load i8* %src.03.unr301, align 1, !dbg !254, !tbaa !255
  %37 = getelementptr inbounds i8* %dest.02.unr302, i64 1, !dbg !254
  store i8 %36, i8* %dest.02.unr302, align 1, !dbg !254, !tbaa !255
...
.lr.ph:                                           ; preds = %.lr.ph.preheader.split, %.lr.ph
  ...
  %39 = getelementptr inbounds i8* %src.03, i64 1, !dbg !254
  %40 = load i8* %src.03, align 1, !dbg !254, !tbaa !255
  %41 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !254
  store i8 %40, i8* %dest.02, align 1, !dbg !254, !tbaa !255
  %42 = getelementptr inbounds i8* %src.03, i64 2, !dbg !254
  %43 = load i8* %39, align 1, !dbg !254, !tbaa !255
  %44 = getelementptr inbounds i8* %dest.02, i64 2, !dbg !254
  store i8 %43, i8* %41, align 1, !dbg !254, !tbaa !255
  %45 = getelementptr inbounds i8* %src.03, i64 3, !dbg !254
  %46 = load i8* %42, align 1, !dbg !254, !tbaa !255
  %47 = getelementptr inbounds i8* %dest.02, i64 3, !dbg !254
  store i8 %46, i8* %44, align 1, !dbg !254, !tbaa !255
  %48 = add i64 %.01, -4, !dbg !252
  %49 = getelementptr inbounds i8* %src.03, i64 4, !dbg !254
  %50 = load i8* %45, align 1, !dbg !254, !tbaa !255
  %51 = getelementptr inbounds i8* %dest.02, i64 4, !dbg !254
  store i8 %50, i8* %47, align 1, !dbg !254, !tbaa !255
  %52 = icmp eq i64 %48, 0, !dbg !252
  br i1 %52, label %._crit_edge, label %.lr.ph, !dbg !252, !llvm.loop !259
...
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #4 {
  %1 = icmp eq i8* %src, %dst, !dbg !261
  br i1 %1, label %.loopexit, label %2, !dbg !261

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !263
  br i1 %3, label %.preheader, label %56, !dbg !263

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !265
  br i1 %4, label %.loopexit, label %overflow.checked227, !dbg !265
...
vector.body218.unr:                               ; preds = %vector.body218.preheader
  %9 = bitcast i8* %src to <16 x i8>*, !dbg !269
  %wide.load445.unr = load <16 x i8>* %9, align 1, !dbg !269, !tbaa !255
  %10 = getelementptr i8* %src, i64 16, !dbg !269
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !269
  %wide.load446.unr = load <16 x i8>* %11, align 1, !dbg !269, !tbaa !255
  %12 = bitcast i8* %dst to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load445.unr, <16 x i8>* %12, align 1, !dbg !269, !tbaa !255
  %13 = getelementptr i8* %dst, i64 16, !dbg !269
  %14 = bitcast i8* %13 to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load446.unr, <16 x i8>* %14, align 1, !dbg !269, !tbaa !255
...
vector.body218:                                   ; preds = %vector.body218.preheader.split, %vector.body218
  ...
  %16 = bitcast i8* %next.gep247 to <16 x i8>*, !dbg !269
  %wide.load445 = load <16 x i8>* %16, align 1, !dbg !269, !tbaa !255
  %next.gep247.sum594 = or i64 %index221, 16, !dbg !269
  %17 = getelementptr i8* %src, i64 %next.gep247.sum594, !dbg !269
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !269
  %wide.load446 = load <16 x i8>* %18, align 1, !dbg !269, !tbaa !255
  %19 = bitcast i8* %next.gep344 to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load445, <16 x i8>* %19, align 1, !dbg !269, !tbaa !255
  %20 = getelementptr i8* %dst, i64 %next.gep247.sum594, !dbg !269
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load446, <16 x i8>* %21, align 1, !dbg !269, !tbaa !255
  ...
  %22 = bitcast i8* %next.gep247.1 to <16 x i8>*, !dbg !269
  %wide.load445.1 = load <16 x i8>* %22, align 1, !dbg !269, !tbaa !255
  %next.gep247.sum594.1 = or i64 %index.next245, 16, !dbg !269
  %23 = getelementptr i8* %src, i64 %next.gep247.sum594.1, !dbg !269
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !269
  %wide.load446.1 = load <16 x i8>* %24, align 1, !dbg !269, !tbaa !255
  %25 = bitcast i8* %next.gep344.1 to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load445.1, <16 x i8>* %25, align 1, !dbg !269, !tbaa !255
  %26 = getelementptr i8* %dst, i64 %next.gep247.sum594.1, !dbg !269
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !269
  store <16 x i8> %wide.load446.1, <16 x i8>* %27, align 1, !dbg !269, !tbaa !255
  %index.next245.1 = add i64 %index221, 64
  %28 = icmp eq i64 %index.next245.1, %n.vec224
  br i1 %28, label %middle.block219, label %vector.body218, !llvm.loop !271
...
.lr.ph.unr:                                       ; preds = %unr.cmp618
  %29 = add i64 %resume.val240, -1, !dbg !265
  %30 = getelementptr inbounds i8* %resume.val235, i64 1, !dbg !269
  %31 = load i8* %resume.val235, align 1, !dbg !269, !tbaa !255
  %32 = getelementptr inbounds i8* %resume.val237, i64 1, !dbg !269
  store i8 %31, i8* %resume.val237, align 1, !dbg !269, !tbaa !255
...
.lr.ph.unr613:                                    ; preds = %.lr.ph.unr, %unr.cmp618
  ...
  %33 = add i64 %.03.unr, -1, !dbg !265
  %34 = getelementptr inbounds i8* %b.05.unr, i64 1, !dbg !269
  %35 = load i8* %b.05.unr, align 1, !dbg !269, !tbaa !255
  %36 = getelementptr inbounds i8* %a.04.unr, i64 1, !dbg !269
  store i8 %35, i8* %a.04.unr, align 1, !dbg !269, !tbaa !255
...
.lr.ph.unr614:                                    ; preds = %.lr.ph.unr613, %unr.cmp618
  ...
  %37 = add i64 %.03.unr617, -1, !dbg !265
  %38 = getelementptr inbounds i8* %b.05.unr615, i64 1, !dbg !269
  %39 = load i8* %b.05.unr615, align 1, !dbg !269, !tbaa !255
  %40 = getelementptr inbounds i8* %a.04.unr616, i64 1, !dbg !269
  store i8 %39, i8* %a.04.unr616, align 1, !dbg !269, !tbaa !255
  br label %.lr.ph.preheader.split
...
.lr.ph:                                           ; preds = %.lr.ph.preheader.split, %.lr.ph
  ...
  %42 = getelementptr inbounds i8* %b.05, i64 1, !dbg !269
  %43 = load i8* %b.05, align 1, !dbg !269, !tbaa !255
  %44 = getelementptr inbounds i8* %a.04, i64 1, !dbg !269
  store i8 %43, i8* %a.04, align 1, !dbg !269, !tbaa !255
  %45 = getelementptr inbounds i8* %b.05, i64 2, !dbg !269
  %46 = load i8* %42, align 1, !dbg !269, !tbaa !255
  %47 = getelementptr inbounds i8* %a.04, i64 2, !dbg !269
  store i8 %46, i8* %44, align 1, !dbg !269, !tbaa !255
  %48 = getelementptr inbounds i8* %b.05, i64 3, !dbg !269
  %49 = load i8* %45, align 1, !dbg !269, !tbaa !255
  %50 = getelementptr inbounds i8* %a.04, i64 3, !dbg !269
  store i8 %49, i8* %47, align 1, !dbg !269, !tbaa !255
  %51 = add i64 %.03, -4, !dbg !265
  %52 = getelementptr inbounds i8* %b.05, i64 4, !dbg !269
  %53 = load i8* %48, align 1, !dbg !269, !tbaa !255
  %54 = getelementptr inbounds i8* %a.04, i64 4, !dbg !269
  store i8 %53, i8* %50, align 1, !dbg !269, !tbaa !255
  %55 = icmp eq i64 %51, 0, !dbg !265
  br i1 %55, label %.loopexit, label %.lr.ph, !dbg !265, !llvm.loop !272

; <label>:56                                      ; preds = %2
  %57 = add i64 %count, -1, !dbg !273
  %58 = icmp eq i64 %count, 0, !dbg !275
  br i1 %58, label %.loopexit, label %.lr.ph9, !dbg !275

.lr.ph9:                                          ; preds = %56
  %59 = getelementptr inbounds i8* %src, i64 %57, !dbg !278
  %60 = getelementptr inbounds i8* %dst, i64 %57, !dbg !273
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %next.gep.sum = add i64 %.sum448, -15, !dbg !279
  %61 = getelementptr i8* %src, i64 %next.gep.sum, !dbg !279
  %62 = bitcast i8* %61 to <16 x i8>*, !dbg !279
  %wide.load = load <16 x i8>* %62, align 1, !dbg !279, !tbaa !255
  %.sum513 = add i64 %.sum448, -31, !dbg !279
  %63 = getelementptr i8* %src, i64 %.sum513, !dbg !279
  %64 = bitcast i8* %63 to <16 x i8>*, !dbg !279
  %wide.load211 = load <16 x i8>* %64, align 1, !dbg !279, !tbaa !255
  %65 = getelementptr i8* %dst, i64 %next.gep.sum, !dbg !279
  %66 = bitcast i8* %65 to <16 x i8>*, !dbg !279
  store <16 x i8> %wide.load, <16 x i8>* %66, align 1, !dbg !279, !tbaa !255
  %67 = getelementptr i8* %dst, i64 %.sum513, !dbg !279
  %68 = bitcast i8* %67 to <16 x i8>*, !dbg !279
  store <16 x i8> %wide.load211, <16 x i8>* %68, align 1, !dbg !279, !tbaa !255
  %index.next = add i64 %index, 32
  %69 = icmp eq i64 %index.next, %n.vec
  br i1 %69, label %middle.block, label %vector.body, !llvm.loop !281
...
scalar.ph.unr:                                    ; preds = %unr.cmp638
  %71 = add i64 %resume.val16, -1, !dbg !275
  %.sum1 = add i64 %70, -1, !dbg !279
  %72 = getelementptr inbounds i8* %src, i64 %.sum1, !dbg !279
  %73 = load i8* %resume.val, align 1, !dbg !279, !tbaa !255
  %74 = getelementptr inbounds i8* %dst, i64 %.sum1, !dbg !279
  store i8 %73, i8* %resume.val12, align 1, !dbg !279, !tbaa !255
...
scalar.ph.unr631:                                 ; preds = %scalar.ph.unr, %unr.cmp638
  ...
  %75 = add i64 %.16.unr, -1, !dbg !275
  %76 = getelementptr inbounds i8* %b.18.unr, i64 -1, !dbg !279
  %77 = load i8* %b.18.unr, align 1, !dbg !279, !tbaa !255
  %78 = getelementptr inbounds i8* %a.17.unr, i64 -1, !dbg !279
  store i8 %77, i8* %a.17.unr, align 1, !dbg !279, !tbaa !255
...
scalar.ph.unr634:                                 ; preds = %scalar.ph.unr631, %unr.cmp638
  ...
  %79 = add i64 %.16.unr637, -1, !dbg !275
  %80 = getelementptr inbounds i8* %b.18.unr635, i64 -1, !dbg !279
  %81 = load i8* %b.18.unr635, align 1, !dbg !279, !tbaa !255
  %82 = getelementptr inbounds i8* %a.17.unr636, i64 -1, !dbg !279
  store i8 %81, i8* %a.17.unr636, align 1, !dbg !279, !tbaa !255
...
scalar.ph:                                        ; preds = %scalar.ph.preheader.split, %scalar.ph
  ...
  %84 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !279
  %85 = load i8* %b.18, align 1, !dbg !279, !tbaa !255
  %86 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !279
  store i8 %85, i8* %a.17, align 1, !dbg !279, !tbaa !255
  %87 = getelementptr inbounds i8* %b.18, i64 -2, !dbg !279
  %88 = load i8* %84, align 1, !dbg !279, !tbaa !255
  %89 = getelementptr inbounds i8* %a.17, i64 -2, !dbg !279
  store i8 %88, i8* %86, align 1, !dbg !279, !tbaa !255
  %90 = getelementptr inbounds i8* %b.18, i64 -3, !dbg !279
  %91 = load i8* %87, align 1, !dbg !279, !tbaa !255
  %92 = getelementptr inbounds i8* %a.17, i64 -3, !dbg !279
  store i8 %91, i8* %89, align 1, !dbg !279, !tbaa !255
  %93 = add i64 %.16, -4, !dbg !275
  %94 = getelementptr inbounds i8* %b.18, i64 -4, !dbg !279
  %95 = load i8* %90, align 1, !dbg !279, !tbaa !255
  %96 = getelementptr inbounds i8* %a.17, i64 -4, !dbg !279
  store i8 %95, i8* %92, align 1, !dbg !279, !tbaa !255
  %97 = icmp eq i64 %93, 0, !dbg !275
  br i1 %97, label %.loopexit, label %scalar.ph, !dbg !275, !llvm.loop !282
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !284
  br i1 %1, label %53, label %overflow.checked, !dbg !284
...
vector.body.unr:                                  ; preds = %vector.body.preheader
  %6 = bitcast i8* %srcaddr to <16 x i8>*, !dbg !286
  %wide.load.unr = load <16 x i8>* %6, align 1, !dbg !286, !tbaa !255
  %7 = getelementptr i8* %srcaddr, i64 16, !dbg !286
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !286
  %wide.load203.unr = load <16 x i8>* %8, align 1, !dbg !286, !tbaa !255
  %9 = bitcast i8* %destaddr to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load.unr, <16 x i8>* %9, align 1, !dbg !286, !tbaa !255
  %10 = getelementptr i8* %destaddr, i64 16, !dbg !286
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load203.unr, <16 x i8>* %11, align 1, !dbg !286, !tbaa !255
  br label %vector.body.preheader.split
...
vector.body:                                      ; preds = %vector.body.preheader.split, %vector.body
  ...
  %13 = bitcast i8* %next.gep to <16 x i8>*, !dbg !286
  %wide.load = load <16 x i8>* %13, align 1, !dbg !286, !tbaa !255
  %next.gep.sum282 = or i64 %index, 16, !dbg !286
  %14 = getelementptr i8* %srcaddr, i64 %next.gep.sum282, !dbg !286
  %15 = bitcast i8* %14 to <16 x i8>*, !dbg !286
  %wide.load203 = load <16 x i8>* %15, align 1, !dbg !286, !tbaa !255
  %16 = bitcast i8* %next.gep106 to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load, <16 x i8>* %16, align 1, !dbg !286, !tbaa !255
  %17 = getelementptr i8* %destaddr, i64 %next.gep.sum282, !dbg !286
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load203, <16 x i8>* %18, align 1, !dbg !286, !tbaa !255
  %index.next = add i64 %index, 32
  %next.gep.1 = getelementptr i8* %srcaddr, i64 %index.next
  %next.gep106.1 = getelementptr i8* %destaddr, i64 %index.next
  %19 = bitcast i8* %next.gep.1 to <16 x i8>*, !dbg !286
  %wide.load.1 = load <16 x i8>* %19, align 1, !dbg !286, !tbaa !255
  %next.gep.sum282.1 = or i64 %index.next, 16, !dbg !286
  %20 = getelementptr i8* %srcaddr, i64 %next.gep.sum282.1, !dbg !286
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !286
  %wide.load203.1 = load <16 x i8>* %21, align 1, !dbg !286, !tbaa !255
  %22 = bitcast i8* %next.gep106.1 to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load.1, <16 x i8>* %22, align 1, !dbg !286, !tbaa !255
  %23 = getelementptr i8* %destaddr, i64 %next.gep.sum282.1, !dbg !286
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !286
  store <16 x i8> %wide.load203.1, <16 x i8>* %24, align 1, !dbg !286, !tbaa !255
  %index.next.1 = add i64 %index, 64
  %25 = icmp eq i64 %index.next.1, %n.vec
  br i1 %25, label %middle.block, label %vector.body, !llvm.loop !287
...
.lr.ph.unr:                                       ; preds = %unr.cmp305
  %26 = add i64 %resume.val9, -1, !dbg !284
  %27 = getelementptr inbounds i8* %resume.val, i64 1, !dbg !286
  %28 = load i8* %resume.val, align 1, !dbg !286, !tbaa !255
  %29 = getelementptr inbounds i8* %resume.val6, i64 1, !dbg !286
  store i8 %28, i8* %resume.val6, align 1, !dbg !286, !tbaa !255
  br label %.lr.ph.unr300
...
.lr.ph.unr300:                                    ; preds = %.lr.ph.unr, %unr.cmp305
  ...
  %30 = add i64 %.01.unr, -1, !dbg !284
  %31 = getelementptr inbounds i8* %src.03.unr, i64 1, !dbg !286
  %32 = load i8* %src.03.unr, align 1, !dbg !286, !tbaa !255
  %33 = getelementptr inbounds i8* %dest.02.unr, i64 1, !dbg !286
  store i8 %32, i8* %dest.02.unr, align 1, !dbg !286, !tbaa !255
...
.lr.ph.unr301:                                    ; preds = %.lr.ph.unr300, %unr.cmp305
  ...
  %34 = add i64 %.01.unr304, -1, !dbg !284
  %35 = getelementptr inbounds i8* %src.03.unr302, i64 1, !dbg !286
  %36 = load i8* %src.03.unr302, align 1, !dbg !286, !tbaa !255
  %37 = getelementptr inbounds i8* %dest.02.unr303, i64 1, !dbg !286
  store i8 %36, i8* %dest.02.unr303, align 1, !dbg !286, !tbaa !255
  br label %.lr.ph.preheader.split
...
.lr.ph:                                           ; preds = %.lr.ph.preheader.split, %.lr.ph
  ...
  %39 = getelementptr inbounds i8* %src.03, i64 1, !dbg !286
  %40 = load i8* %src.03, align 1, !dbg !286, !tbaa !255
  %41 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !286
  store i8 %40, i8* %dest.02, align 1, !dbg !286, !tbaa !255
  %42 = getelementptr inbounds i8* %src.03, i64 2, !dbg !286
  %43 = load i8* %39, align 1, !dbg !286, !tbaa !255
  %44 = getelementptr inbounds i8* %dest.02, i64 2, !dbg !286
  store i8 %43, i8* %41, align 1, !dbg !286, !tbaa !255
  %45 = getelementptr inbounds i8* %src.03, i64 3, !dbg !286
  %46 = load i8* %42, align 1, !dbg !286, !tbaa !255
  %47 = getelementptr inbounds i8* %dest.02, i64 3, !dbg !286
  store i8 %46, i8* %44, align 1, !dbg !286, !tbaa !255
  %48 = add i64 %.01, -4, !dbg !284
  %49 = getelementptr inbounds i8* %src.03, i64 4, !dbg !286
  %50 = load i8* %45, align 1, !dbg !286, !tbaa !255
  %51 = getelementptr inbounds i8* %dest.02, i64 4, !dbg !286
  store i8 %50, i8* %47, align 1, !dbg !286, !tbaa !255
  %52 = icmp eq i64 %48, 0, !dbg !284
  br i1 %52, label %._crit_edge, label %.lr.ph, !dbg !284, !llvm.loop !288
...
; <label>:53                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !289
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !290
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !290

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !292
...
; <label>:3                                       ; preds = %.lr.ph
  %4 = add i64 %count, -1, !dbg !290
  %5 = getelementptr inbounds i8* %dst, i64 1, !dbg !292
  store volatile i8 %2, i8* %dst, align 1, !dbg !292, !tbaa !255
  br label %6

; <label>:6                                       ; preds = %3, %.lr.ph
  %a.02.unr = phi i8* [ %5, %3 ], [ %dst, %.lr.ph ]
  %.01.unr = phi i64 [ %4, %3 ], [ %count, %.lr.ph ]
  %7 = add i64 %.01.unr, -1, !dbg !290
  %8 = getelementptr inbounds i8* %a.02.unr, i64 1, !dbg !292
  store volatile i8 %2, i8* %a.02.unr, align 1, !dbg !292, !tbaa !255
  br label %9

; <label>:9                                       ; preds = %6, %.lr.ph
  %a.02.unr3 = phi i8* [ %8, %6 ], [ %dst, %.lr.ph ]
  %.01.unr4 = phi i64 [ %7, %6 ], [ %count, %.lr.ph ]
  %10 = add i64 %.01.unr4, -1, !dbg !290
  %11 = getelementptr inbounds i8* %a.02.unr3, i64 1, !dbg !292
  store volatile i8 %2, i8* %a.02.unr3, align 1, !dbg !292, !tbaa !255
...
.lr.ph.split.split:                               ; preds = %.lr.ph.split, %.lr.ph.split.split
  ...
  %13 = getelementptr inbounds i8* %a.02, i64 1, !dbg !292
  store volatile i8 %2, i8* %a.02, align 1, !dbg !292, !tbaa !255
  %14 = getelementptr inbounds i8* %a.02, i64 2, !dbg !292
  store volatile i8 %2, i8* %13, align 1, !dbg !292, !tbaa !255
  %15 = getelementptr inbounds i8* %a.02, i64 3, !dbg !292
  store volatile i8 %2, i8* %14, align 1, !dbg !292, !tbaa !255
  %16 = add i64 %.01, -4, !dbg !290
  %17 = getelementptr inbounds i8* %a.02, i64 4, !dbg !292
  store volatile i8 %2, i8* %15, align 1, !dbg !292, !tbaa !255
  %18 = icmp eq i64 %16, 0, !dbg !290
  br i1 %18, label %._crit_edge, label %.lr.ph.split.split, !dbg !290
...
!217 = metadata !{i32 83, i32 2, metadata !14, null}
!218 = metadata !{i32 86, i32 2, metadata !14, null}
!219 = metadata !{i32 88, i32 1, metadata !14, null}
!220 = metadata !{i32 13, i32 7, metadata !221, null}
!221 = metadata !{i32 786443, metadata !22, metadata !21, i32 13, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_div_zero_check.c]
!222 = metadata !{i32 14, i32 5, metadata !221, null}
!223 = metadata !{i32 15, i32 1, metadata !21, null}
!224 = metadata !{i32 15, i32 3, metadata !32, null}
!225 = metadata !{i32 16, i32 3, metadata !32, null}
...
!230 = metadata !{i32 21, i32 7, metadata !231, null}
!231 = metadata !{i32 786443, metadata !46, metadata !45, i32 21, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_overshift_check.c]
!232 = metadata !{i32 27, i32 5, metadata !233, null}
!233 = metadata !{i32 786443, metadata !46, metadata !231, i32 21, i32 26, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_overshift_check.c]
!234 = metadata !{i32 29, i32 1, metadata !45, null}
!235 = metadata !{i32 16, i32 7, metadata !236, null}
!236 = metadata !{i32 786443, metadata !58, metadata !57, i32 16, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!237 = metadata !{i32 17, i32 5, metadata !236, null}
!238 = metadata !{i32 19, i32 7, metadata !239, null}
!239 = metadata !{i32 786443, metadata !58, metadata !57, i32 19, i32 7, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!240 = metadata !{i32 22, i32 5, metadata !241, null}
!241 = metadata !{i32 786443, metadata !58, metadata !239, i32 21, i32 10, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!242 = metadata !{i32 25, i32 9, metadata !243, null}
!243 = metadata !{i32 786443, metadata !58, metadata !241, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!244 = metadata !{i32 26, i32 7, metadata !245, null}
!245 = metadata !{i32 786443, metadata !58, metadata !243, i32 25, i32 19, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!246 = metadata !{i32 27, i32 5, metadata !245, null}
!247 = metadata !{i32 28, i32 7, metadata !248, null}
!248 = metadata !{i32 786443, metadata !58, metadata !243, i32 27, i32 12, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!249 = metadata !{i32 29, i32 7, metadata !248, null}
!250 = metadata !{i32 32, i32 5, metadata !241, null}
!251 = metadata !{i32 34, i32 1, metadata !57, null}
!252 = metadata !{i32 16, i32 3, metadata !253, null}
!253 = metadata !{i32 786443, metadata !71, metadata !70, i32 16, i32 3, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memcpy.c]
!254 = metadata !{i32 17, i32 5, metadata !70, null}
!255 = metadata !{metadata !228, metadata !228, i64 0}
!256 = metadata !{metadata !256, metadata !257, metadata !258}
!257 = metadata !{metadata !"llvm.loop.vectorize.width", i32 1}
!258 = metadata !{metadata !"llvm.loop.interleave.count", i32 1}
!259 = metadata !{metadata !259, metadata !257, metadata !258}
!260 = metadata !{i32 18, i32 3, metadata !70, null}
!261 = metadata !{i32 16, i32 7, metadata !262, null}
!262 = metadata !{i32 786443, metadata !91, metadata !90, i32 16, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!263 = metadata !{i32 19, i32 7, metadata !264, null}
!264 = metadata !{i32 786443, metadata !91, metadata !90, i32 19, i32 7, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!265 = metadata !{i32 20, i32 5, metadata !266, null}
!266 = metadata !{i32 786443, metadata !91, metadata !267, i32 20, i32 5, i32 3, i32 6} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!267 = metadata !{i32 786443, metadata !91, metadata !268, i32 20, i32 5, i32 1, i32 4} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!268 = metadata !{i32 786443, metadata !91, metadata !264, i32 19, i32 16, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!269 = metadata !{i32 20, i32 21, metadata !270, null}
!270 = metadata !{i32 786443, metadata !91, metadata !268, i32 20, i32 21, i32 2, i32 5} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!271 = metadata !{metadata !271, metadata !257, metadata !258}
!272 = metadata !{metadata !272, metadata !257, metadata !258}
!273 = metadata !{i32 22, i32 5, metadata !274, null}
!274 = metadata !{i32 786443, metadata !91, metadata !264, i32 21, i32 10, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!275 = metadata !{i32 24, i32 5, metadata !276, null}
!276 = metadata !{i32 786443, metadata !91, metadata !277, i32 24, i32 5, i32 3, i32 9} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!277 = metadata !{i32 786443, metadata !91, metadata !274, i32 24, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!278 = metadata !{i32 23, i32 5, metadata !274, null}
!279 = metadata !{i32 24, i32 21, metadata !280, null}
!280 = metadata !{i32 786443, metadata !91, metadata !274, i32 24, i32 21, i32 2, i32 8} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!281 = metadata !{metadata !281, metadata !257, metadata !258}
!282 = metadata !{metadata !282, metadata !257, metadata !258}
!283 = metadata !{i32 28, i32 1, metadata !90, null}
!284 = metadata !{i32 15, i32 3, metadata !285, null}
!285 = metadata !{i32 786443, metadata !103, metadata !102, i32 15, i32 3, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/mempcpy.c]
!286 = metadata !{i32 16, i32 5, metadata !102, null}
!287 = metadata !{metadata !287, metadata !257, metadata !258}
!288 = metadata !{metadata !288, metadata !257, metadata !258}
!289 = metadata !{i32 17, i32 3, metadata !102, null}
!290 = metadata !{i32 13, i32 5, metadata !291, null}
!291 = metadata !{i32 786443, metadata !115, metadata !114, i32 13, i32 5, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memset.c]
!292 = metadata !{i32 14, i32 7, metadata !114, null}
!293 = metadata !{i32 15, i32 5, metadata !114, null}
