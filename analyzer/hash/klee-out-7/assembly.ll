...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %6 = getelementptr inbounds [96 x i8]* %key, i32 0, i32 0, !dbg !208
  %7 = load i32* %len, align 4, !dbg !208
  %8 = call i32 (i8*, i32, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i32, i8*, ...)*)(i8* %6, i32 %7, i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)), !dbg !208
  store i32 0, i32* %result, align 4, !dbg !209
  store i32 0, i32* %idata, align 4, !dbg !210
  %9 = call i32 (i32*, i32, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i32, i8*, ...)*)(i32* %idata, i32 4, i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0)), !dbg !211
  %10 = bitcast i32* %result to i8*, !dbg !212
  %11 = getelementptr inbounds [96 x i8]* %key, i32 0, i32 0, !dbg !212
  %12 = bitcast i32* %idata to i8*, !dbg !212
  %13 = load i32* %n, align 4, !dbg !212
  %14 = mul nsw i32 %13, 8, !dbg !212
  %int_cast_to_i64 = zext i32 8 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !212
  %15 = sdiv i32 %14, 8, !dbg !212
  %16 = load i32* %m, align 4, !dbg !212
  %17 = call i8* @hash(i8* %10, i8* %11, i8* %12, i32 %15, i32 %16), !dbg !212
  %18 = load i32* %result, align 4, !dbg !213
  %19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str7, i32 0, i32 0), i32 %18), !dbg !213
  %20 = load i32* %result, align 4, !dbg !214
  %21 = icmp ugt i32 %20, 1, !dbg !214
  br i1 %21, label %22, label %30, !dbg !214

; <label>:22                                      ; preds = %0
  %23 = load i32* %result, align 4, !dbg !216
  %24 = load i32* %m, align 4, !dbg !216
  %int_cast_to_i642 = zext i32 %24 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i642), !dbg !216
  %25 = shl i32 1, %24, !dbg !216
  %int_cast_to_i641 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !216
  %26 = sdiv i32 %25, 2, !dbg !216
  %27 = icmp ult i32 %23, %26, !dbg !216
  br i1 %27, label %28, label %30, !dbg !216

; <label>:28                                      ; preds = %22
  %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str8, i32 0, i32 0)), !dbg !218
  store i32 1, i32* %1, !dbg !220
  br label %34, !dbg !220

; <label>:30                                      ; preds = %22, %0
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str9, i32 0, i32 0)), !dbg !221
  %32 = load i32* %result, align 4, !dbg !223
  %33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str7, i32 0, i32 0), i32 %32), !dbg !223
  store i32 1, i32* %1, !dbg !224
  br label %34, !dbg !224

; <label>:34                                      ; preds = %30, %28
  %35 = load i32* %1, !dbg !225
  ret i32 %35, !dbg !225
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str10, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str111, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str212, i64 0, i64 0)) #7, !dbg !228
  unreachable, !dbg !228
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str313, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !238
  unreachable, !dbg !238
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str614, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !243
  unreachable, !dbg !243
...
!209 = metadata !{i32 78, i32 2, metadata !14, null}
!210 = metadata !{i32 79, i32 2, metadata !14, null}
!211 = metadata !{i32 80, i32 2, metadata !14, null}
!212 = metadata !{i32 81, i32 2, metadata !14, null}
!213 = metadata !{i32 82, i32 2, metadata !14, null}
!214 = metadata !{i32 83, i32 5, metadata !215, null}
!215 = metadata !{i32 786443, metadata !1, metadata !14, i32 83, i32 5, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!216 = metadata !{i32 83, i32 5, metadata !217, null}
!217 = metadata !{i32 786443, metadata !1, metadata !215, i32 83, i32 5, i32 1, i32 29} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!218 = metadata !{i32 84, i32 3, metadata !219, null}
!219 = metadata !{i32 786443, metadata !1, metadata !215, i32 83, i32 33, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!220 = metadata !{i32 85, i32 3, metadata !219, null}
!221 = metadata !{i32 87, i32 3, metadata !222, null}
!222 = metadata !{i32 786443, metadata !1, metadata !215, i32 86, i32 7, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!223 = metadata !{i32 88, i32 3, metadata !222, null}
!224 = metadata !{i32 92, i32 2, metadata !14, null}
!225 = metadata !{i32 94, i32 1, metadata !14, null}
