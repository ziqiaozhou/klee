...
; <label>:17                                      ; preds = %5
  ...
  %29 = load i64* %result, align 8, !dbg !212
  %30 = load i32* %thred, align 4, !dbg !212
  %31 = zext i32 %30 to i64, !dbg !212
  %32 = icmp ugt i64 %29, %31, !dbg !212
  br i1 %32, label %33, label %35, !dbg !212

; <label>:33                                      ; preds = %17
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)), !dbg !214
  store i32 1, i32* %1, !dbg !216
  br label %38, !dbg !216

; <label>:35                                      ; preds = %17
  %36 = load i64* %result, align 8, !dbg !217
  %37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str8, i32 0, i32 0), i64 %36), !dbg !217
  store i32 1, i32* %1, !dbg !219
  br label %38, !dbg !219

; <label>:38                                      ; preds = %35, %33
  %39 = load i32* %1, !dbg !220
  ret i32 %39, !dbg !220
}
