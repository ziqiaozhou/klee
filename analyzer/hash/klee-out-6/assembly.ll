...
; <label>:30                                      ; preds = %16
  store i32 1, i32* %1, !dbg !188
  br label %31, !dbg !188

; <label>:31                                      ; preds = %30, %29
  %32 = load i32* %1, !dbg !189
  ret i32 %32, !dbg !189
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #7, !dbg !192
  unreachable, !dbg !192
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #8, !dbg !194
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #4 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !200
  br i1 %1, label %3, label %2, !dbg !200
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #4 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !205
  br i1 %1, label %3, label %2, !dbg !205

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !207
  unreachable, !dbg !207

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !208
  %5 = icmp eq i32 %4, %end, !dbg !208
  br i1 %5, label %21, label %6, !dbg !208

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !210
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #8, !dbg !210
  %8 = icmp eq i32 %start, 0, !dbg !212
  %9 = load i32* %x, align 4, !dbg !214, !tbaa !196
  br i1 %8, label %10, label %13, !dbg !212

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !214
  %12 = zext i1 %11 to i64, !dbg !214
  call void @klee_assume(i64 %12) #8, !dbg !214
  br label %19, !dbg !216

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !217
  %15 = zext i1 %14 to i64, !dbg !217
  call void @klee_assume(i64 %15) #8, !dbg !217
  %16 = load i32* %x, align 4, !dbg !219, !tbaa !196
  %17 = icmp slt i32 %16, %end, !dbg !219
  %18 = zext i1 %17 to i64, !dbg !219
  call void @klee_assume(i64 %18) #8, !dbg !219
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !220, !tbaa !196
  br label %21, !dbg !220
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !222
  br i1 %1, label %._crit_edge, label %overflow.checked, !dbg !222
...
vector.body.unr:                                  ; preds = %vector.body.preheader
  %6 = bitcast i8* %srcaddr to <16 x i8>*, !dbg !224
  %wide.load.unr = load <16 x i8>* %6, align 1, !dbg !224, !tbaa !225
  %7 = getelementptr i8* %srcaddr, i64 16, !dbg !224
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !224
  %wide.load202.unr = load <16 x i8>* %8, align 1, !dbg !224, !tbaa !225
  %9 = bitcast i8* %destaddr to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load.unr, <16 x i8>* %9, align 1, !dbg !224, !tbaa !225
  %10 = getelementptr i8* %destaddr, i64 16, !dbg !224
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load202.unr, <16 x i8>* %11, align 1, !dbg !224, !tbaa !225
...
vector.body:                                      ; preds = %vector.body.preheader.split, %vector.body
  ...
  %13 = bitcast i8* %next.gep to <16 x i8>*, !dbg !224
  %wide.load = load <16 x i8>* %13, align 1, !dbg !224, !tbaa !225
  %next.gep.sum281 = or i64 %index, 16, !dbg !224
  %14 = getelementptr i8* %srcaddr, i64 %next.gep.sum281, !dbg !224
  %15 = bitcast i8* %14 to <16 x i8>*, !dbg !224
  %wide.load202 = load <16 x i8>* %15, align 1, !dbg !224, !tbaa !225
  %16 = bitcast i8* %next.gep105 to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load, <16 x i8>* %16, align 1, !dbg !224, !tbaa !225
  %17 = getelementptr i8* %destaddr, i64 %next.gep.sum281, !dbg !224
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load202, <16 x i8>* %18, align 1, !dbg !224, !tbaa !225
  %index.next = add i64 %index, 32
  %next.gep.1 = getelementptr i8* %srcaddr, i64 %index.next
  %next.gep105.1 = getelementptr i8* %destaddr, i64 %index.next
  %19 = bitcast i8* %next.gep.1 to <16 x i8>*, !dbg !224
  %wide.load.1 = load <16 x i8>* %19, align 1, !dbg !224, !tbaa !225
  %next.gep.sum281.1 = or i64 %index.next, 16, !dbg !224
  %20 = getelementptr i8* %srcaddr, i64 %next.gep.sum281.1, !dbg !224
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !224
  %wide.load202.1 = load <16 x i8>* %21, align 1, !dbg !224, !tbaa !225
  %22 = bitcast i8* %next.gep105.1 to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load.1, <16 x i8>* %22, align 1, !dbg !224, !tbaa !225
  %23 = getelementptr i8* %destaddr, i64 %next.gep.sum281.1, !dbg !224
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !224
  store <16 x i8> %wide.load202.1, <16 x i8>* %24, align 1, !dbg !224, !tbaa !225
  %index.next.1 = add i64 %index, 64
  %25 = icmp eq i64 %index.next.1, %n.vec
  br i1 %25, label %middle.block, label %vector.body, !llvm.loop !226
...
.lr.ph.unr:                                       ; preds = %unr.cmp304
  %26 = add i64 %resume.val8, -1, !dbg !222
  %27 = getelementptr inbounds i8* %resume.val, i64 1, !dbg !224
  %28 = load i8* %resume.val, align 1, !dbg !224, !tbaa !225
  %29 = getelementptr inbounds i8* %resume.val5, i64 1, !dbg !224
  store i8 %28, i8* %resume.val5, align 1, !dbg !224, !tbaa !225
...
.lr.ph.unr299:                                    ; preds = %.lr.ph.unr, %unr.cmp304
  ...
  %30 = add i64 %.01.unr, -1, !dbg !222
  %31 = getelementptr inbounds i8* %src.03.unr, i64 1, !dbg !224
  %32 = load i8* %src.03.unr, align 1, !dbg !224, !tbaa !225
  %33 = getelementptr inbounds i8* %dest.02.unr, i64 1, !dbg !224
  store i8 %32, i8* %dest.02.unr, align 1, !dbg !224, !tbaa !225
...
.lr.ph.unr300:                                    ; preds = %.lr.ph.unr299, %unr.cmp304
  ...
  %34 = add i64 %.01.unr303, -1, !dbg !222
  %35 = getelementptr inbounds i8* %src.03.unr301, i64 1, !dbg !224
  %36 = load i8* %src.03.unr301, align 1, !dbg !224, !tbaa !225
  %37 = getelementptr inbounds i8* %dest.02.unr302, i64 1, !dbg !224
  store i8 %36, i8* %dest.02.unr302, align 1, !dbg !224, !tbaa !225
...
.lr.ph:                                           ; preds = %.lr.ph.preheader.split, %.lr.ph
  ...
  %39 = getelementptr inbounds i8* %src.03, i64 1, !dbg !224
  %40 = load i8* %src.03, align 1, !dbg !224, !tbaa !225
  %41 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !224
  store i8 %40, i8* %dest.02, align 1, !dbg !224, !tbaa !225
  %42 = getelementptr inbounds i8* %src.03, i64 2, !dbg !224
  %43 = load i8* %39, align 1, !dbg !224, !tbaa !225
  %44 = getelementptr inbounds i8* %dest.02, i64 2, !dbg !224
  store i8 %43, i8* %41, align 1, !dbg !224, !tbaa !225
  %45 = getelementptr inbounds i8* %src.03, i64 3, !dbg !224
  %46 = load i8* %42, align 1, !dbg !224, !tbaa !225
  %47 = getelementptr inbounds i8* %dest.02, i64 3, !dbg !224
  store i8 %46, i8* %44, align 1, !dbg !224, !tbaa !225
  %48 = add i64 %.01, -4, !dbg !222
  %49 = getelementptr inbounds i8* %src.03, i64 4, !dbg !224
  %50 = load i8* %45, align 1, !dbg !224, !tbaa !225
  %51 = getelementptr inbounds i8* %dest.02, i64 4, !dbg !224
  store i8 %50, i8* %47, align 1, !dbg !224, !tbaa !225
  %52 = icmp eq i64 %48, 0, !dbg !222
  br i1 %52, label %._crit_edge, label %.lr.ph, !dbg !222, !llvm.loop !229
...
; <label>:2                                       ; preds = %0
  ...
  br i1 %3, label %.preheader, label %56, !dbg !233

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !235
  br i1 %4, label %.loopexit, label %overflow.checked227, !dbg !235
...
vector.body218.unr:                               ; preds = %vector.body218.preheader
  %9 = bitcast i8* %src to <16 x i8>*, !dbg !239
  %wide.load445.unr = load <16 x i8>* %9, align 1, !dbg !239, !tbaa !225
  %10 = getelementptr i8* %src, i64 16, !dbg !239
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !239
  %wide.load446.unr = load <16 x i8>* %11, align 1, !dbg !239, !tbaa !225
  %12 = bitcast i8* %dst to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load445.unr, <16 x i8>* %12, align 1, !dbg !239, !tbaa !225
  %13 = getelementptr i8* %dst, i64 16, !dbg !239
  %14 = bitcast i8* %13 to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load446.unr, <16 x i8>* %14, align 1, !dbg !239, !tbaa !225
...
vector.body218:                                   ; preds = %vector.body218.preheader.split, %vector.body218
  ...
  %16 = bitcast i8* %next.gep247 to <16 x i8>*, !dbg !239
  %wide.load445 = load <16 x i8>* %16, align 1, !dbg !239, !tbaa !225
  %next.gep247.sum594 = or i64 %index221, 16, !dbg !239
  %17 = getelementptr i8* %src, i64 %next.gep247.sum594, !dbg !239
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !239
  %wide.load446 = load <16 x i8>* %18, align 1, !dbg !239, !tbaa !225
  %19 = bitcast i8* %next.gep344 to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load445, <16 x i8>* %19, align 1, !dbg !239, !tbaa !225
  %20 = getelementptr i8* %dst, i64 %next.gep247.sum594, !dbg !239
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load446, <16 x i8>* %21, align 1, !dbg !239, !tbaa !225
  ...
  %22 = bitcast i8* %next.gep247.1 to <16 x i8>*, !dbg !239
  %wide.load445.1 = load <16 x i8>* %22, align 1, !dbg !239, !tbaa !225
  %next.gep247.sum594.1 = or i64 %index.next245, 16, !dbg !239
  %23 = getelementptr i8* %src, i64 %next.gep247.sum594.1, !dbg !239
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !239
  %wide.load446.1 = load <16 x i8>* %24, align 1, !dbg !239, !tbaa !225
  %25 = bitcast i8* %next.gep344.1 to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load445.1, <16 x i8>* %25, align 1, !dbg !239, !tbaa !225
  %26 = getelementptr i8* %dst, i64 %next.gep247.sum594.1, !dbg !239
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !239
  store <16 x i8> %wide.load446.1, <16 x i8>* %27, align 1, !dbg !239, !tbaa !225
  %index.next245.1 = add i64 %index221, 64
  %28 = icmp eq i64 %index.next245.1, %n.vec224
  br i1 %28, label %middle.block219, label %vector.body218, !llvm.loop !241
...
.lr.ph.unr:                                       ; preds = %unr.cmp618
  %29 = add i64 %resume.val240, -1, !dbg !235
  %30 = getelementptr inbounds i8* %resume.val235, i64 1, !dbg !239
  %31 = load i8* %resume.val235, align 1, !dbg !239, !tbaa !225
  %32 = getelementptr inbounds i8* %resume.val237, i64 1, !dbg !239
  store i8 %31, i8* %resume.val237, align 1, !dbg !239, !tbaa !225
...
.lr.ph.unr613:                                    ; preds = %.lr.ph.unr, %unr.cmp618
  ...
  %33 = add i64 %.03.unr, -1, !dbg !235
  %34 = getelementptr inbounds i8* %b.05.unr, i64 1, !dbg !239
  %35 = load i8* %b.05.unr, align 1, !dbg !239, !tbaa !225
  %36 = getelementptr inbounds i8* %a.04.unr, i64 1, !dbg !239
  store i8 %35, i8* %a.04.unr, align 1, !dbg !239, !tbaa !225
...
.lr.ph.unr614:                                    ; preds = %.lr.ph.unr613, %unr.cmp618
  ...
  %37 = add i64 %.03.unr617, -1, !dbg !235
  %38 = getelementptr inbounds i8* %b.05.unr615, i64 1, !dbg !239
  %39 = load i8* %b.05.unr615, align 1, !dbg !239, !tbaa !225
  %40 = getelementptr inbounds i8* %a.04.unr616, i64 1, !dbg !239
  store i8 %39, i8* %a.04.unr616, align 1, !dbg !239, !tbaa !225
  br label %.lr.ph.preheader.split
...
.lr.ph:                                           ; preds = %.lr.ph.preheader.split, %.lr.ph
  ...
  %42 = getelementptr inbounds i8* %b.05, i64 1, !dbg !239
  %43 = load i8* %b.05, align 1, !dbg !239, !tbaa !225
  %44 = getelementptr inbounds i8* %a.04, i64 1, !dbg !239
  store i8 %43, i8* %a.04, align 1, !dbg !239, !tbaa !225
  %45 = getelementptr inbounds i8* %b.05, i64 2, !dbg !239
  %46 = load i8* %42, align 1, !dbg !239, !tbaa !225
  %47 = getelementptr inbounds i8* %a.04, i64 2, !dbg !239
  store i8 %46, i8* %44, align 1, !dbg !239, !tbaa !225
  %48 = getelementptr inbounds i8* %b.05, i64 3, !dbg !239
  %49 = load i8* %45, align 1, !dbg !239, !tbaa !225
  %50 = getelementptr inbounds i8* %a.04, i64 3, !dbg !239
  store i8 %49, i8* %47, align 1, !dbg !239, !tbaa !225
  %51 = add i64 %.03, -4, !dbg !235
  %52 = getelementptr inbounds i8* %b.05, i64 4, !dbg !239
  %53 = load i8* %48, align 1, !dbg !239, !tbaa !225
  %54 = getelementptr inbounds i8* %a.04, i64 4, !dbg !239
  store i8 %53, i8* %50, align 1, !dbg !239, !tbaa !225
  %55 = icmp eq i64 %51, 0, !dbg !235
  br i1 %55, label %.loopexit, label %.lr.ph, !dbg !235, !llvm.loop !242

; <label>:56                                      ; preds = %2
  %57 = add i64 %count, -1, !dbg !243
  %58 = icmp eq i64 %count, 0, !dbg !245
  br i1 %58, label %.loopexit, label %.lr.ph9, !dbg !245

.lr.ph9:                                          ; preds = %56
  %59 = getelementptr inbounds i8* %src, i64 %57, !dbg !248
  %60 = getelementptr inbounds i8* %dst, i64 %57, !dbg !243
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %next.gep.sum = add i64 %.sum448, -15, !dbg !249
  %61 = getelementptr i8* %src, i64 %next.gep.sum, !dbg !249
  %62 = bitcast i8* %61 to <16 x i8>*, !dbg !249
  %wide.load = load <16 x i8>* %62, align 1, !dbg !249, !tbaa !225
  %.sum513 = add i64 %.sum448, -31, !dbg !249
  %63 = getelementptr i8* %src, i64 %.sum513, !dbg !249
  %64 = bitcast i8* %63 to <16 x i8>*, !dbg !249
  %wide.load211 = load <16 x i8>* %64, align 1, !dbg !249, !tbaa !225
  %65 = getelementptr i8* %dst, i64 %next.gep.sum, !dbg !249
  %66 = bitcast i8* %65 to <16 x i8>*, !dbg !249
  store <16 x i8> %wide.load, <16 x i8>* %66, align 1, !dbg !249, !tbaa !225
  %67 = getelementptr i8* %dst, i64 %.sum513, !dbg !249
  %68 = bitcast i8* %67 to <16 x i8>*, !dbg !249
  store <16 x i8> %wide.load211, <16 x i8>* %68, align 1, !dbg !249, !tbaa !225
  %index.next = add i64 %index, 32
  %69 = icmp eq i64 %index.next, %n.vec
  br i1 %69, label %middle.block, label %vector.body, !llvm.loop !251
...
scalar.ph.unr:                                    ; preds = %unr.cmp638
  %71 = add i64 %resume.val16, -1, !dbg !245
  %.sum1 = add i64 %70, -1, !dbg !249
  %72 = getelementptr inbounds i8* %src, i64 %.sum1, !dbg !249
  %73 = load i8* %resume.val, align 1, !dbg !249, !tbaa !225
  %74 = getelementptr inbounds i8* %dst, i64 %.sum1, !dbg !249
  store i8 %73, i8* %resume.val12, align 1, !dbg !249, !tbaa !225
...
scalar.ph.unr631:                                 ; preds = %scalar.ph.unr, %unr.cmp638
  ...
  %75 = add i64 %.16.unr, -1, !dbg !245
  %76 = getelementptr inbounds i8* %b.18.unr, i64 -1, !dbg !249
  %77 = load i8* %b.18.unr, align 1, !dbg !249, !tbaa !225
  %78 = getelementptr inbounds i8* %a.17.unr, i64 -1, !dbg !249
  store i8 %77, i8* %a.17.unr, align 1, !dbg !249, !tbaa !225
...
scalar.ph.unr634:                                 ; preds = %scalar.ph.unr631, %unr.cmp638
  ...
  %79 = add i64 %.16.unr637, -1, !dbg !245
  %80 = getelementptr inbounds i8* %b.18.unr635, i64 -1, !dbg !249
  %81 = load i8* %b.18.unr635, align 1, !dbg !249, !tbaa !225
  %82 = getelementptr inbounds i8* %a.17.unr636, i64 -1, !dbg !249
  store i8 %81, i8* %a.17.unr636, align 1, !dbg !249, !tbaa !225
...
scalar.ph:                                        ; preds = %scalar.ph.preheader.split, %scalar.ph
  ...
  %84 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !249
  %85 = load i8* %b.18, align 1, !dbg !249, !tbaa !225
  %86 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !249
  store i8 %85, i8* %a.17, align 1, !dbg !249, !tbaa !225
  %87 = getelementptr inbounds i8* %b.18, i64 -2, !dbg !249
  %88 = load i8* %84, align 1, !dbg !249, !tbaa !225
  %89 = getelementptr inbounds i8* %a.17, i64 -2, !dbg !249
  store i8 %88, i8* %86, align 1, !dbg !249, !tbaa !225
  %90 = getelementptr inbounds i8* %b.18, i64 -3, !dbg !249
  %91 = load i8* %87, align 1, !dbg !249, !tbaa !225
  %92 = getelementptr inbounds i8* %a.17, i64 -3, !dbg !249
  store i8 %91, i8* %89, align 1, !dbg !249, !tbaa !225
  %93 = add i64 %.16, -4, !dbg !245
  %94 = getelementptr inbounds i8* %b.18, i64 -4, !dbg !249
  %95 = load i8* %90, align 1, !dbg !249, !tbaa !225
  %96 = getelementptr inbounds i8* %a.17, i64 -4, !dbg !249
  store i8 %95, i8* %92, align 1, !dbg !249, !tbaa !225
  %97 = icmp eq i64 %93, 0, !dbg !245
  br i1 %97, label %.loopexit, label %scalar.ph, !dbg !245, !llvm.loop !252
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  ...
  br i1 %1, label %53, label %overflow.checked, !dbg !254
...
vector.body.unr:                                  ; preds = %vector.body.preheader
  ...
  %wide.load.unr = load <16 x i8>* %6, align 1, !dbg !256, !tbaa !225
  %7 = getelementptr i8* %srcaddr, i64 16, !dbg !256
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !256
  %wide.load203.unr = load <16 x i8>* %8, align 1, !dbg !256, !tbaa !225
  %9 = bitcast i8* %destaddr to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load.unr, <16 x i8>* %9, align 1, !dbg !256, !tbaa !225
  %10 = getelementptr i8* %destaddr, i64 16, !dbg !256
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load203.unr, <16 x i8>* %11, align 1, !dbg !256, !tbaa !225
  br label %vector.body.preheader.split
...
vector.body:                                      ; preds = %vector.body.preheader.split, %vector.body
  ...
  %wide.load = load <16 x i8>* %13, align 1, !dbg !256, !tbaa !225
  %next.gep.sum282 = or i64 %index, 16, !dbg !256
  %14 = getelementptr i8* %srcaddr, i64 %next.gep.sum282, !dbg !256
  %15 = bitcast i8* %14 to <16 x i8>*, !dbg !256
  %wide.load203 = load <16 x i8>* %15, align 1, !dbg !256, !tbaa !225
  %16 = bitcast i8* %next.gep106 to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load, <16 x i8>* %16, align 1, !dbg !256, !tbaa !225
  %17 = getelementptr i8* %destaddr, i64 %next.gep.sum282, !dbg !256
  %18 = bitcast i8* %17 to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load203, <16 x i8>* %18, align 1, !dbg !256, !tbaa !225
  %index.next = add i64 %index, 32
  %next.gep.1 = getelementptr i8* %srcaddr, i64 %index.next
  %next.gep106.1 = getelementptr i8* %destaddr, i64 %index.next
  %19 = bitcast i8* %next.gep.1 to <16 x i8>*, !dbg !256
  %wide.load.1 = load <16 x i8>* %19, align 1, !dbg !256, !tbaa !225
  %next.gep.sum282.1 = or i64 %index.next, 16, !dbg !256
  %20 = getelementptr i8* %srcaddr, i64 %next.gep.sum282.1, !dbg !256
  %21 = bitcast i8* %20 to <16 x i8>*, !dbg !256
  %wide.load203.1 = load <16 x i8>* %21, align 1, !dbg !256, !tbaa !225
  %22 = bitcast i8* %next.gep106.1 to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load.1, <16 x i8>* %22, align 1, !dbg !256, !tbaa !225
  %23 = getelementptr i8* %destaddr, i64 %next.gep.sum282.1, !dbg !256
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !256
  store <16 x i8> %wide.load203.1, <16 x i8>* %24, align 1, !dbg !256, !tbaa !225
  %index.next.1 = add i64 %index, 64
  %25 = icmp eq i64 %index.next.1, %n.vec
...
.lr.ph.unr:                                       ; preds = %unr.cmp305
  %26 = add i64 %resume.val9, -1, !dbg !254
  %27 = getelementptr inbounds i8* %resume.val, i64 1, !dbg !256
  %28 = load i8* %resume.val, align 1, !dbg !256, !tbaa !225
  %29 = getelementptr inbounds i8* %resume.val6, i64 1, !dbg !256
  store i8 %28, i8* %resume.val6, align 1, !dbg !256, !tbaa !225
  br label %.lr.ph.unr300
...
.lr.ph.unr300:                                    ; preds = %.lr.ph.unr, %unr.cmp305
  ...
  %32 = load i8* %src.03.unr, align 1, !dbg !256, !tbaa !225
  %33 = getelementptr inbounds i8* %dest.02.unr, i64 1, !dbg !256
  store i8 %32, i8* %dest.02.unr, align 1, !dbg !256, !tbaa !225
...
.lr.ph.unr301:                                    ; preds = %.lr.ph.unr300, %unr.cmp305
  ...
  %34 = add i64 %.01.unr304, -1, !dbg !254
  %35 = getelementptr inbounds i8* %src.03.unr302, i64 1, !dbg !256
  %36 = load i8* %src.03.unr302, align 1, !dbg !256, !tbaa !225
  %37 = getelementptr inbounds i8* %dest.02.unr303, i64 1, !dbg !256
  store i8 %36, i8* %dest.02.unr303, align 1, !dbg !256, !tbaa !225
  br label %.lr.ph.preheader.split
...
; <label>:53                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !259
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !260
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !260

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !262
...
; <label>:3                                       ; preds = %.lr.ph
  %4 = add i64 %count, -1, !dbg !260
  %5 = getelementptr inbounds i8* %dst, i64 1, !dbg !262
  store volatile i8 %2, i8* %dst, align 1, !dbg !262, !tbaa !225
  br label %6

; <label>:6                                       ; preds = %3, %.lr.ph
  %a.02.unr = phi i8* [ %5, %3 ], [ %dst, %.lr.ph ]
  %.01.unr = phi i64 [ %4, %3 ], [ %count, %.lr.ph ]
  %7 = add i64 %.01.unr, -1, !dbg !260
  %8 = getelementptr inbounds i8* %a.02.unr, i64 1, !dbg !262
  store volatile i8 %2, i8* %a.02.unr, align 1, !dbg !262, !tbaa !225
  br label %9

; <label>:9                                       ; preds = %6, %.lr.ph
  %a.02.unr3 = phi i8* [ %8, %6 ], [ %dst, %.lr.ph ]
  %.01.unr4 = phi i64 [ %7, %6 ], [ %count, %.lr.ph ]
  %10 = add i64 %.01.unr4, -1, !dbg !260
  %11 = getelementptr inbounds i8* %a.02.unr3, i64 1, !dbg !262
  store volatile i8 %2, i8* %a.02.unr3, align 1, !dbg !262, !tbaa !225
...
.lr.ph.split.split:                               ; preds = %.lr.ph.split, %.lr.ph.split.split
  ...
  %13 = getelementptr inbounds i8* %a.02, i64 1, !dbg !262
  store volatile i8 %2, i8* %a.02, align 1, !dbg !262, !tbaa !225
  %14 = getelementptr inbounds i8* %a.02, i64 2, !dbg !262
  store volatile i8 %2, i8* %13, align 1, !dbg !262, !tbaa !225
  %15 = getelementptr inbounds i8* %a.02, i64 3, !dbg !262
  store volatile i8 %2, i8* %14, align 1, !dbg !262, !tbaa !225
  %16 = add i64 %.01, -4, !dbg !260
  %17 = getelementptr inbounds i8* %a.02, i64 4, !dbg !262
  store volatile i8 %2, i8* %15, align 1, !dbg !262, !tbaa !225
  %18 = icmp eq i64 %16, 0, !dbg !260
  br i1 %18, label %._crit_edge, label %.lr.ph.split.split, !dbg !260
...
!189 = metadata !{i32 49, i32 1, metadata !11, null}
!190 = metadata !{i32 13, i32 7, metadata !191, null}
!191 = metadata !{i32 786443, metadata !19, metadata !18, i32 13, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_div_zero_check.c]
!192 = metadata !{i32 14, i32 5, metadata !191, null}
!193 = metadata !{i32 15, i32 1, metadata !18, null}
!194 = metadata !{i32 15, i32 3, metadata !29, null}
!195 = metadata !{i32 16, i32 3, metadata !29, null}
!196 = metadata !{metadata !197, metadata !197, i64 0}
!197 = metadata !{metadata !"int", metadata !198, i64 0}
!198 = metadata !{metadata !"omnipotent char", metadata !199, i64 0}
!199 = metadata !{metadata !"Simple C/C++ TBAA"}
!200 = metadata !{i32 21, i32 7, metadata !201, null}
!201 = metadata !{i32 786443, metadata !43, metadata !42, i32 21, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_overshift_check.c]
!202 = metadata !{i32 27, i32 5, metadata !203, null}
!203 = metadata !{i32 786443, metadata !43, metadata !201, i32 21, i32 26, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_overshift_check.c]
!204 = metadata !{i32 29, i32 1, metadata !42, null}
!205 = metadata !{i32 16, i32 7, metadata !206, null}
!206 = metadata !{i32 786443, metadata !55, metadata !54, i32 16, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!207 = metadata !{i32 17, i32 5, metadata !206, null}
!208 = metadata !{i32 19, i32 7, metadata !209, null}
!209 = metadata !{i32 786443, metadata !55, metadata !54, i32 19, i32 7, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!210 = metadata !{i32 22, i32 5, metadata !211, null}
!211 = metadata !{i32 786443, metadata !55, metadata !209, i32 21, i32 10, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!212 = metadata !{i32 25, i32 9, metadata !213, null}
!213 = metadata !{i32 786443, metadata !55, metadata !211, i32 25, i32 9, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!214 = metadata !{i32 26, i32 7, metadata !215, null}
!215 = metadata !{i32 786443, metadata !55, metadata !213, i32 25, i32 19, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!216 = metadata !{i32 27, i32 5, metadata !215, null}
!217 = metadata !{i32 28, i32 7, metadata !218, null}
!218 = metadata !{i32 786443, metadata !55, metadata !213, i32 27, i32 12, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/klee_range.c]
!219 = metadata !{i32 29, i32 7, metadata !218, null}
!220 = metadata !{i32 32, i32 5, metadata !211, null}
!221 = metadata !{i32 34, i32 1, metadata !54, null}
!222 = metadata !{i32 16, i32 3, metadata !223, null}
!223 = metadata !{i32 786443, metadata !68, metadata !67, i32 16, i32 3, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memcpy.c]
!224 = metadata !{i32 17, i32 5, metadata !67, null}
!225 = metadata !{metadata !198, metadata !198, i64 0}
!226 = metadata !{metadata !226, metadata !227, metadata !228}
!227 = metadata !{metadata !"llvm.loop.vectorize.width", i32 1}
!228 = metadata !{metadata !"llvm.loop.interleave.count", i32 1}
!229 = metadata !{metadata !229, metadata !227, metadata !228}
!230 = metadata !{i32 18, i32 3, metadata !67, null}
!231 = metadata !{i32 16, i32 7, metadata !232, null}
!232 = metadata !{i32 786443, metadata !88, metadata !87, i32 16, i32 7, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!233 = metadata !{i32 19, i32 7, metadata !234, null}
!234 = metadata !{i32 786443, metadata !88, metadata !87, i32 19, i32 7, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!235 = metadata !{i32 20, i32 5, metadata !236, null}
!236 = metadata !{i32 786443, metadata !88, metadata !237, i32 20, i32 5, i32 3, i32 6} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!237 = metadata !{i32 786443, metadata !88, metadata !238, i32 20, i32 5, i32 1, i32 4} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!238 = metadata !{i32 786443, metadata !88, metadata !234, i32 19, i32 16, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!239 = metadata !{i32 20, i32 21, metadata !240, null}
!240 = metadata !{i32 786443, metadata !88, metadata !238, i32 20, i32 21, i32 2, i32 5} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!241 = metadata !{metadata !241, metadata !227, metadata !228}
!242 = metadata !{metadata !242, metadata !227, metadata !228}
!243 = metadata !{i32 22, i32 5, metadata !244, null}
!244 = metadata !{i32 786443, metadata !88, metadata !234, i32 21, i32 10, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!245 = metadata !{i32 24, i32 5, metadata !246, null}
!246 = metadata !{i32 786443, metadata !88, metadata !247, i32 24, i32 5, i32 3, i32 9} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!247 = metadata !{i32 786443, metadata !88, metadata !244, i32 24, i32 5, i32 1, i32 7} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!248 = metadata !{i32 23, i32 5, metadata !244, null}
!249 = metadata !{i32 24, i32 21, metadata !250, null}
!250 = metadata !{i32 786443, metadata !88, metadata !244, i32 24, i32 21, i32 2, i32 8} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memmove.c]
!251 = metadata !{metadata !251, metadata !227, metadata !228}
!252 = metadata !{metadata !252, metadata !227, metadata !228}
!253 = metadata !{i32 28, i32 1, metadata !87, null}
!254 = metadata !{i32 15, i32 3, metadata !255, null}
!255 = metadata !{i32 786443, metadata !100, metadata !99, i32 15, i32 3, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/mempcpy.c]
!256 = metadata !{i32 16, i32 5, metadata !99, null}
!257 = metadata !{metadata !257, metadata !227, metadata !228}
!258 = metadata !{metadata !258, metadata !227, metadata !228}
!259 = metadata !{i32 17, i32 3, metadata !99, null}
!260 = metadata !{i32 13, i32 5, metadata !261, null}
!261 = metadata !{i32 786443, metadata !112, metadata !111, i32 13, i32 5, i32 1, i32 0} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/runtime/Intrinsic/memset.c]
!262 = metadata !{i32 14, i32 7, metadata !111, null}
!263 = metadata !{i32 15, i32 5, metadata !111, null}
