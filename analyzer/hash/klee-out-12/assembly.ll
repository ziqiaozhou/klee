...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  store i32 11, i32* %m, align 4, !dbg !241
  %5 = getelementptr inbounds [96 x i8]* %key, i32 0, i32 0, !dbg !242
  %6 = load i32* %len, align 4, !dbg !242
  %7 = call i32 (i8*, i32, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i32, i8*, ...)*)(i8* %5, i32 %6, i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)), !dbg !242
  store i32 0, i32* %result, align 4, !dbg !243
  store i32 0, i32* %idata, align 4, !dbg !244
  %8 = call i32 (i32*, i32, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i32, i8*, ...)*)(i32* %idata, i32 4, i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0)), !dbg !245
  %9 = bitcast i32* %result to i8*, !dbg !246
  %10 = getelementptr inbounds [96 x i8]* %key, i32 0, i32 0, !dbg !246
  %11 = bitcast i32* %idata to i8*, !dbg !246
  %12 = load i32* %n, align 4, !dbg !246
  %13 = mul nsw i32 %12, 8, !dbg !246
  %int_cast_to_i64 = zext i32 8 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !246
  %14 = sdiv i32 %13, 8, !dbg !246
  %15 = load i32* %m, align 4, !dbg !246
  %16 = call i8* @hash(i8* %9, i8* %10, i8* %11, i32 %14, i32 %15), !dbg !246
  %17 = load i32* %result, align 4, !dbg !247
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str7, i32 0, i32 0), i32 %17), !dbg !247
  %19 = load i32* %result, align 4, !dbg !248
  %20 = icmp ugt i32 %19, 1, !dbg !248
  %21 = load i32* %result, align 4
  %22 = icmp ult i32 %21, 10, !dbg !250
  %or.cond = and i1 %20, %22, !dbg !248
  br i1 %or.cond, label %23, label %25, !dbg !248

; <label>:23                                      ; preds = %0
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str8, i32 0, i32 0)), !dbg !252
  store i32 1, i32* %1, !dbg !254
  br label %29, !dbg !254

; <label>:25                                      ; preds = %0
  %26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str9, i32 0, i32 0)), !dbg !255
  %27 = load i32* %result, align 4, !dbg !257
  %28 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str7, i32 0, i32 0), i32 %27), !dbg !257
  store i32 1, i32* %1, !dbg !258
  br label %29, !dbg !258

; <label>:29                                      ; preds = %25, %23
  %30 = load i32* %1, !dbg !259
  ret i32 %30, !dbg !259
}
...
!238 = metadata !{i32 90, i32 2, metadata !14, null}
!239 = metadata !{i32 91, i32 2, metadata !14, null}
!240 = metadata !{i32 93, i32 2, metadata !14, null}
!241 = metadata !{i32 98, i32 4, metadata !14, null}
!242 = metadata !{i32 99, i32 3, metadata !14, null}
!243 = metadata !{i32 101, i32 2, metadata !14, null}
!244 = metadata !{i32 102, i32 2, metadata !14, null}
...
!248 = metadata !{i32 106, i32 5, metadata !249, null}
!249 = metadata !{i32 786443, metadata !1, metadata !14, i32 106, i32 5, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!250 = metadata !{i32 106, i32 5, metadata !251, null}
!251 = metadata !{i32 786443, metadata !1, metadata !249, i32 106, i32 5, i32 1, i32 39} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!252 = metadata !{i32 107, i32 3, metadata !253, null}
!253 = metadata !{i32 786443, metadata !1, metadata !249, i32 106, i32 27, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!254 = metadata !{i32 108, i32 3, metadata !253, null}
!255 = metadata !{i32 110, i32 3, metadata !256, null}
!256 = metadata !{i32 786443, metadata !1, metadata !249, i32 109, i32 7, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!257 = metadata !{i32 111, i32 3, metadata !256, null}
!258 = metadata !{i32 115, i32 2, metadata !14, null}
!259 = metadata !{i32 117, i32 1, metadata !14, null}
