...
; <label>:18                                      ; preds = %5
  %19 = load i32* %x, align 4, !dbg !208
  store i32 %19, i32* %idata, align 4, !dbg !208
  %20 = call i32 (i32*, i32, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i32, i8*, ...)*)(i32* %idata, i32 4, i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0)), !dbg !209
  %21 = bitcast i64* %result to i8*, !dbg !210
  %22 = getelementptr inbounds [96 x i8]* %key, i32 0, i32 0, !dbg !210
  %23 = bitcast i32* %idata to i8*, !dbg !210
  %24 = load i32* %n, align 4, !dbg !210
  %25 = mul nsw i32 %24, 8, !dbg !210
  %int_cast_to_i64 = zext i32 8 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !210
  %26 = sdiv i32 %25, 8, !dbg !210
  %27 = load i32* %m, align 4, !dbg !210
  %28 = mul nsw i32 %27, 8, !dbg !210
  %int_cast_to_i641 = zext i32 8 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !210
  %29 = sdiv i32 %28, 8, !dbg !210
  %30 = call i8* @hash(i8* %21, i8* %22, i8* %23, i32 %26, i32 %29), !dbg !210
  %31 = load i64* %result, align 8, !dbg !211
  %32 = icmp ult i64 %31, 10000, !dbg !211
  br i1 %32, label %33, label %35, !dbg !211

; <label>:33                                      ; preds = %18
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)), !dbg !213
  store i32 0, i32* %1, !dbg !215
  br label %38, !dbg !215

; <label>:35                                      ; preds = %18
  %36 = load i64* %result, align 8, !dbg !216
  %37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str8, i32 0, i32 0), i64 %36), !dbg !216
  store i32 1, i32* %1, !dbg !217
  br label %38, !dbg !217

; <label>:38                                      ; preds = %35, %33
  %39 = load i32* %1, !dbg !218
  ret i32 %39, !dbg !218
}
...
!209 = metadata !{i32 74, i32 3, metadata !14, null}
!210 = metadata !{i32 75, i32 2, metadata !14, null}
!211 = metadata !{i32 76, i32 5, metadata !212, null}
!212 = metadata !{i32 786443, metadata !1, metadata !14, i32 76, i32 5, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!213 = metadata !{i32 77, i32 3, metadata !214, null}
!214 = metadata !{i32 786443, metadata !1, metadata !212, i32 76, i32 18, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/playpen/ziqiao/2project/klee/analyzer/hash/hash.c]
!215 = metadata !{i32 78, i32 3, metadata !214, null}
!216 = metadata !{i32 80, i32 2, metadata !14, null}
!217 = metadata !{i32 83, i32 2, metadata !14, null}
!218 = metadata !{i32 85, i32 1, metadata !14, null}
